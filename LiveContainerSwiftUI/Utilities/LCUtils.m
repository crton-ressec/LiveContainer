...
+ (NSString *)liveProcessBundleIdentifier {
    ...
    NSString *bundleID = [NSString stringWithFormat:@"com.crton.liveproxy.%@.LiveProcess", LCSharedUtils.teamIdentifier];
...
+ (void)changeMainExecutableTo:(NSString *)exec error:(NSError **)error {
    NSURL *infoPath = [LCSharedUtils.appGroupPath URLByAppendingPathComponent:@"Apps/com.crton.liveproxy/App.app/Info.plist"];
