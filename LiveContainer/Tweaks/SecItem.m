...
void SecItemGuestHooksInit(void)  {
    ...
    if(keychainGroupId == 0) {
        accessGroup = [NSString stringWithFormat:@"%@.com.crton.liveproxy.shared", groupId];
    } else {
        accessGroup = [NSString stringWithFormat:@"%@.com.crton.liveproxy.shared.%d", groupId, keychainGroupId];
    }
